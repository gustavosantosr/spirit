...
/*UpdateServicioTipo endpoint para grabar salidas*/
 func UpdateServicioTipo(w http.ResponseWriter, r *http.Request) {
...
IDItem,status, err:= bd.UpdateServicioTipo(item)
if err != nil {
	http.Error(w, "Error al actualizar el Tipo de Vehiculo" + err.Error(), http.StatusBadRequest)
	return
}
